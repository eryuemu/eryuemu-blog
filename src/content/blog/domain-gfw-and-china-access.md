---
title: '域名、GFW 与国内访问：十一个疑问与实测解答'
description: 'ITDOG 测速图引出的十一个域名问题，按「问题 → 结论 → 证据」的形式，记录 2026-08-12 关掉代理、纯国内网络实测得到的全部答案。其中 Q9–Q11 是拿到前八个结论后继续追问的三个问题：github.io 为什么没被一起污染、「握手掐」是什么、剩下的 23 个超时怎么办。'
pubDate: '2026-08-12'
category: '开发'
type: 'ai-organized'
---
