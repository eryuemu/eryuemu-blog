...
### 2.3 破案细节：为什么买域名早在 7 月，却恰好是这 3 个被收录？

很多站长会有疑问：“我的域名早在 7 月中旬就买好并上线了，为什么 GSC 面板里既不是全部收录、也不是全部重定向，而是精准地‘收录了 3 个，重定向了 4 个’？而且这 7 个页面为什么会在 8 月 14 日同时跳出来？”
...
| :--- | :--- | :--- | :--- |
| `https://eryuemu.com/blog/knowledge-base-and-blog-setup/` | **7 月 27 日** | 网页会自动重定向 | 域名配置期撞上 308 跳转 |
...
- **路径 A（成功收录通道）：GitHub 外链引导与首页内链**
  1. 7 月中旬上线后，你在 GitHub Profile、开源仓库 README 等公开渠道留下了个人博客首页 `https://eryuemu.com`。
