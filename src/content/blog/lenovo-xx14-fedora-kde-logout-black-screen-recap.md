...
于是推翻"不用还原"的结论，定下一条还原原则：**除修 bug 必需的改动外，其余全部还原**。带着这个疑问逐项核对（这次的复盘阵型是两台电脑两套 AI 接力：游戏本跑 Antigravity 交叉验证结论，小新 14 本机跑 Trae 执行核对与还原），结果发现 Gemini 收尾时给出的两个结论本身就不成立，还原范围因此比预想的更大。以下是逐项修正。
